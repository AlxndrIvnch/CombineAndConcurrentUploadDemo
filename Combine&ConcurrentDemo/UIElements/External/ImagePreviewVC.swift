...
class ImagePreviewVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout  {
    ...
    override func viewDidLoad() {
        ...
        myCollectionView.scrollToItem(at: passedContentOffset, at: .centeredHorizontally, animated: false)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ImagePreviewFullViewCell", for: indexPath) as! ImagePreviewFullViewCell
        cell.imgView.setImage(with: imgArray[indexPath.item])
        return cell
    }
